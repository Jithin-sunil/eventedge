      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="Student.php"><img src="../Assets/Templates/Main/images/logo.png"></a></div>
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="banner_taital_main">
                                       ...
                                       <h1 class="banner_taital">EVENT EDGE</h1>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                        ...
                        <div class="carousel-item">
                           <div class="container-fluid">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="banner_taital_main">
                                       <h3 class="banner_text">EVENT EDGE</h3>
                                       <h1 class="banner_taital">Indira Gandhi Colleage Of Arts And Science</h1>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="social_icon">
            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="../Assets/Templates/Main/images/icon-1.png"></div>
                        <div class="app_icon_1"><img src="../Assets/Templates/Main/images/icon-1.png"></div>
                        <h4 class="services_text active">App Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="../Assets/Templates/Main/images/icon-2.png"></div>
                        <div class="app_icon_1"><img src="../Assets/Templates/Main/images/icon-6.png"></div>
                        <h4 class="services_text">Website Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="../Assets/Templates/Main/images/icon-3.png"></div>
                        <div class="app_icon_1"><img src="../Assets/Templates/Main/images/icon-7.png"></div>
                        <h4 class="services_text">Html And Css</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="../Assets/Templates/Main/images/icon-4.png"></div>
                        <div class="app_icon_1"><img src="../Assets/Templates/Main/images/icon-8.png"></div>
            ...
            <div class="portfolio_section">
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="container_main">
                           <img src="../Assets/Templates/Main/images/img-1.png" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="../Assets/Templates/Main/images/img-2.png" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
               ...
               <div class="portfolio_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="../Assets/Templates/Main/images/img-3.png" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="../Assets/Templates/Main/images/img-4.png" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="../Assets/Templates/Main/images/img-5.png" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
