...
if (isset($_GET['aid'])) {
    $update = "UPDATE tbl_teacher SET teacher_status='1' WHERE teacher_id='" . $_GET["aid"] . "'";
    if ($con->query($update)) {
        echo "<script>
                alert('Accepted');
...
<body>
    <div class="container table-container">
        <h2 class="text-center mb-4">New Teachers</h2>
        <form id="form1" name="form1" method="post" action="">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $selqry = "SELECT * FROM tbl_teacher t 
                               INNER JOIN tbl_department d ON d.department_id = t.department_id where teacher_status='0'";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="ViewTeacher.php?aid=<?php echo $row['teacher_id']; ?>"
                                    class="btn btn-success btn-sm btn-action">Accept</a>
                                <a href="ViewTeacher.php?rid=<?php echo $row['teacher_id']; ?>"
            ...
            <form id="form1" name="form1" method="post" action="">
                ...
                <h2 class="text-center mb-4">Rejected Teachers</h2>
                <form id="form1" name="form1" method="post" action="">
                    <table class="table table-bordered table-striped">
                        <thead class="table-dark">
                            <tr>
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $selqry = "SELECT * FROM tbl_teacher t 
                               INNER JOIN tbl_department d ON d.department_id = t.department_id where teacher_status='2'";
                            $result = $con->query($selqry);
                            while ($row = $result->fetch_assoc()) {
                                $i++;
                                ?>
